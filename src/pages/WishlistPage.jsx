            ...
            {wishlistItems.map((product) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-blue-600 dark:text-blue-400 font-mono font-black text-lg mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-xl text-xs font-bold transition-all shadow-md shadow-blue-200 dark:shadow-none"
                    >
