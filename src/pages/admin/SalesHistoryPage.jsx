          ...
          <div className="flex gap-3">
            <div className="relative">
              ...
              <input 
                ...
                className="pl-9 pr-3 py-3.5 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl text-xs font-medium text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <div className="relative">
              <Calendar size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
              <input 
                ...
                <tbody>
                  {filteredRecords.map(r => (
                    <tr key={r.id} className="border-b border-gray-50 dark:border-slate-800/50 hover:bg-gray-50/50 dark:hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right text-sm font-bold text-blue-600 dark:text-blue-400 font-mono">{formatPrice(r.totalPrice)}</td>
            ...
            <div className="space-y-4">
              ...
              {saleForm.productId && saleForm.quantitySold > 0 && saleForm.unitPrice > 0 && (
                <div className="p-4 bg-blue-50 dark:bg-blue-900/10 rounded-xl border border-blue-100 dark:border-blue-800/30">
                  <p className="text-xs font-black uppercase tracking-widest text-blue-400 mb-1">{t('totalPrice')}</p>
                  <p className="text-2xl font-black text-blue-600 dark:text-blue-400 font-mono">{formatPrice(Number(saleForm.unitPrice) * Number(saleForm.quantitySold))}</p>
                </div>
              )}
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button onClick={handleAddSale}
                  className="flex-1 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-bold transition-all shadow-lg shadow-blue-500/30">{t('recordSale')}</button>
              </div>
            </div>
          </div>
        </Backdrop>
