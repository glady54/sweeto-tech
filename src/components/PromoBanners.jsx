                  ...
                  <div className="mt-auto">
                    {isButton ? (
                      <Link
                        ...
                        className="inline-block bg-[#0066ee] hover:bg-blue-700 text-white text-sm font-medium px-6 py-2.5 rounded-full transition-colors shadow-sm"
                      >
                        Buy Now
                      </Link>
                    ) : (
                      <Link
                        to={`/product/${product.id}`}
                        className="inline-block text-gray-900 dark:text-white text-sm font-medium pb-0.5 border-b-2 border-gray-900 dark:border-white hover:text-blue-600 hover:border-blue-600 dark:hover:text-blue-400 dark:hover:border-blue-400 transition-colors"
                      >
                        Learn More
                      </Link>
                    )}
