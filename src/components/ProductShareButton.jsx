  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`flex items-center gap-2.5 px-5 py-3.5 rounded-2xl border-2 font-bold text-sm transition-all duration-200 transform active:scale-95 select-none
          ${isOpen
            ? 'bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-200 dark:shadow-none'
            : 'bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 text-gray-700 dark:text-gray-200 hover:border-blue-400 hover:text-blue-600 dark:hover:border-blue-500 dark:hover:text-blue-400'
          }`}
        ...
        >
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-2.5 px-4 py-3 rounded-2xl border text-sm font-bold transition-all duration-200 active:scale-95
              ${copied
                ...
                : 'bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700 text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:border-blue-300 dark:hover:border-blue-700 hover:text-blue-600 dark:hover:text-blue-400'
              }`}
          >
            {copied ? (
              <>
          ...
          {typeof navigator !== 'undefined' && navigator.share && (
            <button
              ...
              className="w-full mt-2 flex items-center justify-center gap-2.5 px-4 py-3 rounded-2xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-sm font-bold hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-all duration-200 active:scale-95"
            >
              <Send size={16} />
              <span>More Apps…</span>
            </button>
