    ...
    <section className="max-w-[1400px] mx-auto px-4 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
        <div className="relative">
          <div className="flex items-center gap-4 text-blue-600 font-black text-xs uppercase tracking-[0.3em] mb-4">
        ...
        {categories.map((category) => {
          ...
          return (
            <Link
              ...
              className="group relative flex-none w-[200px] md:w-auto h-[280px] md:h-auto bg-white border border-slate-100 p-8 rounded-[2.5rem] flex flex-col items-center justify-center text-center transition-all duration-500 hover:shadow-[0_40px_80px_-20px_rgba(37,99,235,0.15)] hover:-translate-y-4 hover:border-blue-200 snap-center overflow-hidden"
            >
              {/* Mesh Gradient Background Effect (Hover) */}
              <div className="absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-700 pointer-events-none bg-[radial-gradient(circle_at_50%_50%,#2563eb_0%,transparent_70%)]"></div>
              ...
              <div className="relative w-24 h-24 rounded-full flex items-center justify-center mb-6 transition-all duration-700 group-hover:scale-110">
                <div className="absolute inset-0 rounded-full bg-slate-50 transition-all duration-700 group-hover:bg-blue-600/5 group-hover:rotate-45 group-hover:rounded-[2rem]"></div>
                
                {/* Inner Glow Lens */}
                <div className="absolute inset-2 rounded-full border border-slate-200/50 group-hover:border-blue-500/20 group-hover:animate-pulse"></div>
                ...
                {category.image ? (
                  ...
                  <IconComponent size={36} className="relative z-10 text-slate-400 group-hover:text-blue-600 transition-all duration-500 group-hover:translate-y-[-2px]" />
                )}
              </div>
              
              <div className="relative z-10">
                <h3 className="font-black text-slate-900 text-base tracking-tight mb-2 group-hover:text-blue-600 transition-colors">
                  {category.name}
                </h3>
                <div className="h-0.5 w-0 group-hover:w-8 bg-blue-600 mx-auto transition-all duration-500 rounded-full"></div>
              ...
              <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-12 h-1 bg-blue-600 rounded-t-full translate-y-full group-hover:translate-y-0 transition-transform duration-500"></div>
            </Link>
          );
        })}
      </div>
