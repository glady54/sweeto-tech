...
const CategoryBanners = () => {
  ...
  const gradients = [
    'from-blue-50 to-indigo-100 dark:from-slate-800 dark:to-slate-900',
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className={`mt-3 inline-flex items-center gap-2 text-white text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-xl transition-all ${buttonColors[i]}`}>
